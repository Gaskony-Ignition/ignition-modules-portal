...
| **Download** | [ClaudeCode-WebUI-6.9.0.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/claude-code-v6.9.0/ClaudeCode-WebUI-6.9.0.modl) |
| **Size** | 46 MB |
...
| | |
|---|---|
| **Latest Version** | v3.6.15 |
| **Download** | [Python3-3.6.15.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/python3-integration-v3.6.15/Python3-3.6.15.modl) |
| **Size** | 50 MB |
...
| Claude AI Terminal | v6.9.0 | 8.3+ | 17 | Claude API key |
| Git Integration | v1.3.48 | 8.3+ | 17 | Git server (GitHub, GitLab, etc.) |
| Logix PLC Emulator | v9.0.4 | 8.3+ | 17 | None |
| Python 3 Integration | v3.6.15 | 8.3+ | 17 | Python 3.8+ on server |
