...
| **Download** | [ClaudeCode-WebUI-5.24.0.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/claude-code-v5.24.0/ClaudeCode-WebUI-5.24.0.modl) |
| **Size** | 46 MB |
...
| Claude Code WebUI | v5.24.0 | 8.3+ | 17 | Claude API key |
