...
| **Download** | [CameraDriver-3.0.1.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/camera-driver-v3.0.1/CameraDriver-3.0.1.modl) |
| **Size** | 18 MB |
...
| **Download** | [Python3-4.5.2.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/python3-integration-v4.5.2/Python3-4.5.2.modl) |
| **Size** | 50 MB |
...
| Python 3 Integration | v4.5.2 | 8.3+ | 17 | Python 3.8+ on server |
