...
| **Download** | [CameraDriver-2.21.0.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/camera-driver-v2.21.0/CameraDriver-2.21.0.modl) |
| **Size** | 18 MB |
...
| **Download** | [ClaudeCode-WebUI-7.0.0.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/claude-code-v7.0.0/ClaudeCode-WebUI-7.0.0.modl) |
| **Size** | 46 MB |
...
|--------|---------|----------|------|------------------------|
| Camera Driver | v2.21.0 | 8.3+ | 17 | Network access to cameras |
| Claude AI Terminal | v7.0.0 | 8.3+ | 17 | Claude API key |
