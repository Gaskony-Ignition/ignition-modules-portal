...
| **Download** | [CameraDriver-2.27.0.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/camera-driver-v2.27.0/CameraDriver-2.27.0.modl) |
| **Size** | 18 MB |
...
| **Download** | [ClaudeCode-WebUI-7.2.5.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/claude-code-v7.2.5/ClaudeCode-WebUI-7.2.5.modl) |
| **Size** | 46 MB |
...
| **Download** | [Ignition-Git-Module-1.3.54.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/git-module-v1.3.54/Ignition-Git-Module-1.3.54.modl) |
| **Size** | 28 MB |
...
| **Download** | [Python3-3.8.2.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/python3-integration-v3.8.2/Python3-3.8.2.modl) |
| **Size** | 50 MB |
...
|--------|---------|----------|------|------------------------|
| Camera Driver | v2.27.0 | 8.3+ | 17 | Network access to cameras |
| Claude AI Terminal | v7.2.5 | 8.3+ | 17 | Claude API key |
| Git Integration | v1.3.54 | 8.3+ | 17 | Git server (GitHub, GitLab, etc.) |
| Logix PLC Emulator | v9.1.1 | 8.3+ | 17 | None |
| Python 3 Integration | v3.8.2 | 8.3+ | 17 | Python 3.8+ on server |
