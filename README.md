...
| | |
|---|---|
| **Latest Version** | v1.3.28 |
| **Download** | [Ignition-Git-Module-1.3.28.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/git-module-v1.3.28/Ignition-Git-Module-1.3.28.modl) |
| **Size** | 28 MB |
...
| Git Integration | v1.3.28 | 8.3+ | 17 | Git server (GitHub, GitLab, etc.) |
