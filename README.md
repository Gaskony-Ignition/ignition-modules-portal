...
| **Download** | [CameraDriver-2.20.0.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/camera-driver-v2.20.0/CameraDriver-2.20.0.modl) |
| **Size** | 18 MB |
...
| **Download** | [ClaudeCode-WebUI-6.8.0.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/claude-code-v6.8.0/ClaudeCode-WebUI-6.8.0.modl) |
| **Size** | 46 MB |
...
| **Download** | [Ignition-Git-Module-1.3.48.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/git-module-v1.3.48/Ignition-Git-Module-1.3.48.modl) |
| **Size** | 28 MB |
...
| | |
|---|---|
| **Latest Version** | v9.0.4 |
| **Download** | [LogixPLCEmulator-9.0.4.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/logix-emulator-v9.0.4/LogixPLCEmulator-9.0.4.modl) |
| **Size** | 12 MB |
...
| | |
|---|---|
| **Latest Version** | v3.6.14 |
| **Download** | [Python3-3.6.14.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/python3-integration-v3.6.14/Python3-3.6.14.modl) |
| **Size** | 50 MB |
...
|--------|---------|----------|------|------------------------|
| Camera Driver | v2.20.0 | 8.3+ | 17 | Network access to cameras |
| Claude AI Terminal | v6.8.0 | 8.3+ | 17 | Claude API key |
| Git Integration | v1.3.48 | 8.3+ | 17 | Git server (GitHub, GitLab, etc.) |
| Logix PLC Emulator | v9.0.4 | 8.3+ | 17 | None |
| Python 3 Integration | v3.6.14 | 8.3+ | 17 | Python 3.8+ on server |
