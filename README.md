...
| **Download** | [ClaudeCode-WebUI-7.3.0.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/claude-code-v7.3.0/ClaudeCode-WebUI-7.3.0.modl) |
| **Size** | 46 MB |
...
| Claude AI Terminal | v7.3.0 | 8.3+ | 17 | Claude API key |
