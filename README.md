...
| **Download** | [ClaudeCode-WebUI-6.3.1.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/claude-code-v6.3.1/ClaudeCode-WebUI-6.3.1.modl) |
| **Size** | 46 MB |
...
| Claude AI Terminal | v6.3.1 | 8.3+ | 17 | Claude API key |
