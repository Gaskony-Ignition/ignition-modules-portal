...
| **Download** | [Python3-3.5.3.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/python3-integration-v3.5.3/Python3-3.5.3.modl) |
| **Size** | 50 MB |
...
| Python 3 Integration | v3.5.3 | 8.3+ | 17 | Python 3.8+ on server |
