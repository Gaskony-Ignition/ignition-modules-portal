...
| Python 3 Integration | v4.6.3 | Apache-2.0 | [module-python3](https://github.com/Gaskony-Ignition/module-python3) |
| Git Integration | v3.9.9 | Beerware | [module-git-integration](https://github.com/Gaskony-Ignition/module-git-integration) |
| Script IDE | v1.26.1 | Apache-2.0 | [module-script-ide](https://github.com/Gaskony-Ignition/module-script-ide) |
