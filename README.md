...
| **Download** | [CameraDriver-2.7.9.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/camera-driver-v2.7.9/CameraDriver-2.7.9.modl) |
| **Size** | 18 MB |
...
| | |
|---|---|
| **Latest Version** | v5.25.6 |
| **Download** | [ClaudeCode-WebUI-5.25.6.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/claude-code-v5.25.6/ClaudeCode-WebUI-5.25.6.modl) |
| **Size** | 46 MB |
...
| | |
|---|---|
| **Latest Version** | v1.3.33 |
| **Download** | [Ignition-Git-Module-1.3.33.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/git-module-v1.3.33/Ignition-Git-Module-1.3.33.modl) |
| **Size** | 28 MB |
...
| | |
|---|---|
| **Latest Version** | v8.2.12 |
| **Download** | [LogixPLCEmulator-8.2.12.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/logix-emulator-v8.2.12/LogixPLCEmulator-8.2.12.modl) |
| **Size** | 12 MB |
...
| **Download** | [Python3-3.5.7.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/python3-integration-v3.5.7/Python3-3.5.7.modl) |
| **Size** | 50 MB |
...
|--------|---------|----------|------|------------------------|
| Camera Driver | v2.7.9 | 8.3+ | 17 | Network access to cameras |
| Claude AI Terminal | v5.25.6 | 8.3+ | 17 | Claude API key |
| Git Integration | v1.3.33 | 8.3+ | 17 | Git server (GitHub, GitLab, etc.) |
| Logix PLC Emulator | v8.2.12 | 8.3+ | 17 | None |
| Python 3 Integration | v3.5.7 | 8.3+ | 17 | Python 3.8+ on server |
