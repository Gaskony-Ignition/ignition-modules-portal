...
| **Download** | [ClaudeCode-WebUI-6.2.2.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/claude-code-v6.2.2/ClaudeCode-WebUI-6.2.2.modl) |
| **Size** | 46 MB |
...
| | |
|---|---|
| **Latest Version** | v3.6.9 |
| **Download** | [Python3-3.6.9.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/python3-integration-v3.6.9/Python3-3.6.9.modl) |
| **Size** | 50 MB |
...
| Claude AI Terminal | v6.2.2 | 8.3+ | 17 | Claude API key |
| Git Integration | v1.3.41 | 8.3+ | 17 | Git server (GitHub, GitLab, etc.) |
| Logix PLC Emulator | v9.0.4 | 8.3+ | 17 | None |
| Python 3 Integration | v3.6.9 | 8.3+ | 17 | Python 3.8+ on server |
