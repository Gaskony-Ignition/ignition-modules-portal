...
| | |
|---|---|
| **Latest Version** | v5.25.3 |
| **Download** | [ClaudeCode-WebUI-5.25.3.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/claude-code-v5.25.3/ClaudeCode-WebUI-5.25.3.modl) |
| **Size** | 46 MB |
...
| Claude AI Terminal | v5.25.3 | 8.3+ | 17 | Claude API key |
