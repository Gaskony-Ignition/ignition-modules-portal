...
| **Download** | [CameraDriver-2.17.0.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/camera-driver-v2.17.0/CameraDriver-2.17.0.modl) |
| **Size** | 18 MB |
...
|--------|---------|----------|------|------------------------|
| Camera Driver | v2.17.0 | 8.3+ | 17 | Network access to cameras |
