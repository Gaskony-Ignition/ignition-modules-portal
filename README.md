...
| **Download** | [Python3-3.6.8.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/python3-integration-v3.6.8/Python3-3.6.8.modl) |
| **Size** | 50 MB |
...
| Python 3 Integration | v3.6.8 | 8.3+ | 17 | Python 3.8+ on server |
