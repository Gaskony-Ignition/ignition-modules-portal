...
| | |
|---|---|
| **Latest Version** | v8.2.18 |
| **Download** | [LogixPLCEmulator-8.2.18.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/logix-emulator-v8.2.18/LogixPLCEmulator-8.2.18.modl) |
| **Size** | 12 MB |
...
| **Download** | [Python3-3.6.5.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/python3-integration-v3.6.5/Python3-3.6.5.modl) |
| **Size** | 50 MB |
...
| Python 3 Integration | v3.6.5 | 8.3+ | 17 | Python 3.8+ on server |
