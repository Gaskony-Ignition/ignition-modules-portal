...
| | |
|---|---|
| **Latest Version** | v5.25.5 |
| **Download** | [ClaudeCode-WebUI-5.25.5.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/claude-code-v5.25.5/ClaudeCode-WebUI-5.25.5.modl) |
| **Size** | 46 MB |
...
| | |
|---|---|
| **Latest Version** | v1.3.32 |
| **Download** | [Ignition-Git-Module-1.3.32.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/git-module-v1.3.32/Ignition-Git-Module-1.3.32.modl) |
| **Size** | 28 MB |
...
| **Download** | [Python3-3.5.4.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/python3-integration-v3.5.4/Python3-3.5.4.modl) |
| **Size** | 50 MB |
...
| Claude AI Terminal | v5.25.5 | 8.3+ | 17 | Claude API key |
| Git Integration | v1.3.32 | 8.3+ | 17 | Git server (GitHub, GitLab, etc.) |
| Logix PLC Emulator | v8.2.11 | 8.3+ | 17 | None |
| Python 3 Integration | v3.5.4 | 8.3+ | 17 | Python 3.8+ on server |
