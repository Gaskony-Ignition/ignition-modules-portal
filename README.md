...
| **Download** | [ClaudeCode-WebUI-6.1.0.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/claude-code-v6.1.0/ClaudeCode-WebUI-6.1.0.modl) |
| **Size** | 46 MB |
...
| **Download** | [Ignition-Git-Module-1.3.40.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/git-module-v1.3.40/Ignition-Git-Module-1.3.40.modl) |
| **Size** | 28 MB |
...
| Claude AI Terminal | v6.1.0 | 8.3+ | 17 | Claude API key |
