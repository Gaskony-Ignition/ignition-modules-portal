...
| **Download** | [CameraDriver-2.15.0.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/camera-driver-v2.15.0/CameraDriver-2.15.0.modl) |
| **Size** | 18 MB |
...
| **Download** | [ClaudeCode-WebUI-6.3.0.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/claude-code-v6.3.0/ClaudeCode-WebUI-6.3.0.modl) |
| **Size** | 46 MB |
...
|--------|---------|----------|------|------------------------|
| Camera Driver | v2.15.0 | 8.3+ | 17 | Network access to cameras |
| Claude AI Terminal | v6.3.0 | 8.3+ | 17 | Claude API key |
