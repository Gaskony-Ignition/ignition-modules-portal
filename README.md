...
| **Download** | [CameraDriver-2.25.0.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/camera-driver-v2.25.0/CameraDriver-2.25.0.modl) |
| **Size** | 18 MB |
...
| **Download** | [ClaudeCode-WebUI-7.2.1.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/claude-code-v7.2.1/ClaudeCode-WebUI-7.2.1.modl) |
| **Size** | 46 MB |
...
| **Download** | [Ignition-Git-Module-1.3.53.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/git-module-v1.3.53/Ignition-Git-Module-1.3.53.modl) |
| **Size** | 28 MB |
...
|--------|---------|----------|------|------------------------|
| Camera Driver | v2.25.0 | 8.3+ | 17 | Network access to cameras |
| Claude AI Terminal | v7.2.1 | 8.3+ | 17 | Claude API key |
| Git Integration | v1.3.53 | 8.3+ | 17 | Git server (GitHub, GitLab, etc.) |
