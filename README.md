...
| **Download** | [CameraDriver-2.11.0.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/camera-driver-v2.11.0/CameraDriver-2.11.0.modl) |
| **Size** | 18 MB |
...
| **Download** | [ClaudeCode-WebUI-6.0.0.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/claude-code-v6.0.0/ClaudeCode-WebUI-6.0.0.modl) |
| **Size** | 46 MB |
...
| | |
|---|---|
| **Latest Version** | v1.3.39 |
| **Download** | [Ignition-Git-Module-1.3.39.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/git-module-v1.3.39/Ignition-Git-Module-1.3.39.modl) |
| **Size** | 28 MB |
...
| **Download** | [LogixPLCEmulator-9.0.0.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/logix-emulator-v9.0.0/LogixPLCEmulator-9.0.0.modl) |
| **Size** | 12 MB |
...
| **Download** | [Python3-3.6.6.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/python3-integration-v3.6.6/Python3-3.6.6.modl) |
| **Size** | 50 MB |
...
| Claude AI Terminal | v6.0.0 | 8.3+ | 17 | Claude API key |
| Git Integration | v1.3.39 | 8.3+ | 17 | Git server (GitHub, GitLab, etc.) |
| Logix PLC Emulator | v9.0.0 | 8.3+ | 17 | None |
| Python 3 Integration | v3.6.6 | 8.3+ | 17 | Python 3.8+ on server |
