...
| **Download** | [ClaudeCode-WebUI-7.2.2.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/claude-code-v7.2.2/ClaudeCode-WebUI-7.2.2.modl) |
| **Size** | 46 MB |
...
| Claude AI Terminal | v7.2.2 | 8.3+ | 17 | Claude API key |
