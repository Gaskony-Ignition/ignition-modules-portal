...
| | |
|---|---|
| **Latest Version** | v5.16.3 |
| **Download** | [ClaudeCode-WebUI-5.16.3.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/claude-code-v5.16.3/ClaudeCode-WebUI-5.16.3.modl) |
| **Size** | 46 MB |
...
| Claude Code WebUI | v5.16.3 | 8.3+ | 17 | Claude API key |
