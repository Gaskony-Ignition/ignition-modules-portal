...
| **Download** | [CameraDriver-2.18.0.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/camera-driver-v2.18.0/CameraDriver-2.18.0.modl) |
| **Size** | 18 MB |
...
| **Download** | [ClaudeCode-WebUI-6.5.1.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/claude-code-v6.5.1/ClaudeCode-WebUI-6.5.1.modl) |
| **Size** | 46 MB |
...
| **Download** | [Ignition-Git-Module-1.3.41.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/git-module-v1.3.41/Ignition-Git-Module-1.3.41.modl) |
| **Size** | 28 MB |
...
| | |
|---|---|
| **Latest Version** | v3.6.11 |
| **Download** | [Python3-3.6.11.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/python3-integration-v3.6.11/Python3-3.6.11.modl) |
| **Size** | 50 MB |
...
|--------|---------|----------|------|------------------------|
| Camera Driver | v2.18.0 | 8.3+ | 17 | Network access to cameras |
| Claude AI Terminal | v6.5.1 | 8.3+ | 17 | Claude API key |
| Git Integration | v1.3.41 | 8.3+ | 17 | Git server (GitHub, GitLab, etc.) |
| Logix PLC Emulator | v9.0.4 | 8.3+ | 17 | None |
| Python 3 Integration | v3.6.11 | 8.3+ | 17 | Python 3.8+ on server |
