...
| **Download** | [CameraDriver-2.19.0.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/camera-driver-v2.19.0/CameraDriver-2.19.0.modl) |
| **Size** | 18 MB |
...
|--------|---------|----------|------|------------------------|
| Camera Driver | v2.19.0 | 8.3+ | 17 | Network access to cameras |
