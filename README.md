...
| | |
|---|---|
| **Latest Version** | v5.25.4 |
| **Download** | [ClaudeCode-WebUI-5.25.4.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/claude-code-v5.25.4/ClaudeCode-WebUI-5.25.4.modl) |
| **Size** | 46 MB |
...
| | |
|---|---|
| **Latest Version** | v1.3.30 |
| **Download** | [Ignition-Git-Module-1.3.30.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/git-module-v1.3.30/Ignition-Git-Module-1.3.30.modl) |
| **Size** | 28 MB |
...
| **Download** | [Python3-3.5.1.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/python3-integration-v3.5.1/Python3-3.5.1.modl) |
| **Size** | 50 MB |
...
| Claude AI Terminal | v5.25.4 | 8.3+ | 17 | Claude API key |
| Git Integration | v1.3.30 | 8.3+ | 17 | Git server (GitHub, GitLab, etc.) |
| Logix PLC Emulator | v8.2.11 | 8.3+ | 17 | None |
| Python 3 Integration | v3.5.1 | 8.3+ | 17 | Python 3.8+ on server |
