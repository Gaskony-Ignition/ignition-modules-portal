...
| **Download** | [CameraDriver-2.33.0.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/camera-driver-v2.33.0/CameraDriver-2.33.0.modl) |
| **Size** | 18 MB |
...
| **Download** | [Python3-3.11.0.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/python3-integration-v3.11.0/Python3-3.11.0.modl) |
| **Size** | 50 MB |
...
|--------|---------|----------|------|------------------------|
| Camera Driver | v2.33.0 | 8.3+ | 17 | Network access to cameras |
...
| Python 3 Integration | v3.11.0 | 8.3+ | 17 | Python 3.8+ on server |
