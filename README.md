...
| **Download** | [Python3-4.1.0.modl](https://github.com/Gaskony-Ignition/ignition-modules-portal/releases/download/python3-integration-v4.1.0/Python3-4.1.0.modl) |
| **Size** | 50 MB |
...
| Python 3 Integration | v4.1.0 | 8.3+ | 17 | Python 3.8+ on server |
